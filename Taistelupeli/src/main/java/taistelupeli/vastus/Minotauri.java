...
public class Minotauri extends Morko {
     ...
     *
     * Erikoistaidon ollessa voimassa hyökkäyksen vahinko on huomattavasti
     * suurempi.
     *
    ...
    /**
     * Metodi asettaa Minotaurin erikoiskyvyn voimaan, vahvistaen seuravaa
     * normaalihyökkäystä.
     * @return ryntäyksen tekstikuvaus
     */
    @Override
    public String spesialisoi() {
        ryntays = true;
        return "Hirviömäinen otus polkee sorkkajalkaansa maata vasten ja"
